...
public class CSVWritter {
	...
	public void guardarSalidaA(LinkedList<Aeropuerto> a) {
		...
		try {
			File file = new File("C:/Users/jcann/TPE/src/tpe/Dataget/salidaA.csv");
			if (!file.exists())
				file.createNewFile();
	...
	public void guardarSalidaB(LinkedList<Reserva> r) {
		BufferedWriter bw = null;
		try {
			File file = new File("C:/Users/jcann/TPE/src/tpe/Dataget/salidaB.csv");
			if (!file.exists())
				file.createNewFile();
			FileWriter fw = new FileWriter(file);
			bw = new BufferedWriter(fw);
	...
	public void guardarSalidaC(Ruta r, String a, int p, double d) {
		BufferedWriter bw = null;
		try {
			File file = new File("C:/Users/jcann/TPE/src/tpe/Dataget/salidaC.csv");
			if (!file.exists())
				file.createNewFile();
			FileWriter fw = new FileWriter(file);
			bw = new BufferedWriter(fw);
	...
	public void guardarSalidaD(LinkedList<LinkedList<Ruta>> servicio2, String o, String d, String a) {
		BufferedWriter bw = null;
		try {
			File file = new File("C:/Users/jcann/TPE/src/tpe/Dataget/salidaD.csv");
			if (!file.exists())
				file.createNewFile();
			FileWriter fw = new FileWriter(file);
			bw = new BufferedWriter(fw);
	...
	public void guardarSalidaE(LinkedList<Ruta> r, String p1, String p2) {
		BufferedWriter bw = null;
		try {
			File file = new File("C:/Users/jcann/TPE/src/tpe/Dataget/salidaE.csv");
			if (!file.exists())
				file.createNewFile();
			FileWriter fw = new FileWriter(file);
			bw = new BufferedWriter(fw);
